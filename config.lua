...
Config.GetUpKey = 38 -- Key Config by default. You can customize this to any key you want.

Config.GetUpText = 'E - Get Up' -- Text to show when sitting
...
Config.Sitable = {
	...
	--For all Scenarios: pastebin.com/6mrYTdQv
